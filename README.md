...
Repository to accompany the substack __Data For Science__
...
All the code is runnable in [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/DataForScience/Graphs4Sci/master) and each blog post corresponds to a different notebook

25\. [Graph Neural Networks 101: Predicting Molecular Properties from Scratch](https://graphs4sci.substack.com/p/graph-neural-networks-101) - [Graph Neural Networks 101.ipynb](https://github.com/DataForScience/Graphs4Sci/blob/master/Graph%20Neural%20Networks%20101.ipynb)
...
8\. [Node Centrality: Degree, Closeness, and Betweenness Centrality](https://graphs4sci.substack.com/p/node-centrality) - [Node Centrality.ipynb](https://github.com/DataForScience/Graphs4Sci/blob/master/Node%20Centrality.ipynb)

7\. [Graph Embeddings 101: From word2vec to node2vec, and beyond](https://graphs4sci.substack.com/p/graph-embeddings-101) - [node2vec.ipynb](https://github.com/DataForScience/Graphs4Sci/blob/master/node2vec.ipynb)
...
3\. [Understanding DBSCAN and K-NN with Random Geometric Graphs](https://graphs4sci.substack.com/p/understanding-dbscan-and-k-nn-with) - [Random Networks.ipynb](https://github.com/DataForScience/Graphs4Sci/blob/master/Random%20Networks.ipynb)
